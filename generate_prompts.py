...
# Load NSFW tags (assuming nsfw.json might have simpler structures or its own detailed ones)
with open('nsfw.json', 'r', encoding='utf-8') as f:
    ty = json.load(f) # This ty should also ideally follow the 6-part structure if it needs char flags
